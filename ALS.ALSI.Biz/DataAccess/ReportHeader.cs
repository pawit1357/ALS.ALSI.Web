    ...
    public class ReportHeader
    {
        ...
        public ReportHeader getReportHeder(job_sample _sample)
        {
            ...
            if (_job != null)
            {
                ...
                rpt.alsRefNo = String.Format("{4}ATT/{0}/{1}/{2}-{3}", tmp[0], _job.date_of_receive.Value.ToString("yy"), tmp[1], tmp[2],(_sample.amend_count>0? (_sample.amend_count == 1 ? "AM/":"AM/"+ _sample.amend_count) :""));// _sample.job_number.ToString();

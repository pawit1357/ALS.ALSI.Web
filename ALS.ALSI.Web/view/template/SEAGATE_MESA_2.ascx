<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SEAGATE_MESA_2.ascx.cs" Inherits="ALS.ALSI.Web.view.template.SEAGATE_MESA_2" %>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="txtSampleSize_Extraction" runat="server" Text="1 piece" CssClass="form-control"></asp:TextBox>
                                            </td>
                                            <td>
...
"
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <asp:GridView ID="gvResult" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Disc Location" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Ghost Symptom Detection" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                    ...
                    <asp:Panel ID="pRefImage" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label class="control-label col-md-3">SEM IMAGE AT 200X: </label>
                                    <div class="col-md-3">
                        ...
                        <div class="col-md-9">
                            <asp:GridView ID="gvRefImages" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="SEM IMAGE AT 200X" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>

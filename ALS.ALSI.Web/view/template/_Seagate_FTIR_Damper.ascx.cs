...
//                    ddlUnit.SelectedValue = this.Ftir.selected_unit_ftir.Value.ToString();
...
//                    //this.Ftir.selected_unit = lbUnitFtir.Text.Equals("ng/cm2") ? 1 : 2;
//                    this.Ftir.selected_unit_nvr = lbUnitNvr.Text.Equals("ng/cm2") ? 1 : 2;

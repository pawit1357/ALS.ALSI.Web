<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PA02.ascx.cs" Inherits="ALS.ALSI.Web.view.template.PA02" %>
            ...
            <div class="portlet box blue-dark">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <asp:Button ID="btnPage08" runat="server" Text="P08" CssClass="btn btn-default btn-sm" OnClick="btnCoverPage_Click" />
                ...
                <div class="portlet-body">
                    ...
                    <asp:Panel ID="pPage01" runat="server">
                        ...
                        <asp:GridView CssClass="table table-striped table-bordered table-advance table-hover" ID="gvEop" runat="server" AutoGenerateColumns="False" DataKeyNames="ID,row_status" OnRowDataBound="gvEop_RowDataBound" OnRowCommand="gvEop_RowCommand" OnRowCancelingEdit="gvEop_RowCancelingEdit" OnRowDeleting="gvEop_RowDeleting" OnRowEditing="gvEop_RowEditing" OnRowUpdating="gvEop_RowUpdating">
                            <Columns>
                                <asp:TemplateField HeaderText="1Metallic particle and \nNon-metallic particle" ItemStyle-HorizontalAlign="Right">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="50 ≤ X < 100" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="100 ≤ X < 150" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="150 ≤ X < 200" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="200 ≤ X < 400" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="X ≥ 400" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>

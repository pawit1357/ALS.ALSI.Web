...
{
    public partial class WD_HPA_FOR_1_V2 : System.Web.UI.UserControl
    {
        ...
        protected void ddlSpecification_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (detailSpec != null)
            {
                String[] particleClassificationList = { "Hard Particles", "Total MgSiO Particles", "Total Steel Particles", "Total Cr / O, Cr / Mn / O", "Total Magnetic Particles" };
                ...
                int seq = 1;
                foreach (String name in particleClassificationList)
                {
                    ...
                    switch (seq)
                    {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            _tmp.D = (CustomUtils.isNumber(detailSpec.F) && !detailSpec.F.Equals("0") ? String.Format("<{0}", detailSpec.F) : detailSpec.F);
                            break;
                        case 4:
                            _tmp.D = (CustomUtils.isNumber(detailSpec.G) && !detailSpec.G.Equals("0") ? String.Format("<{0}", detailSpec.G) : detailSpec.G);
                            break;
                        case 5:
                            _tmp.D = (CustomUtils.isNumber(detailSpec.H) && !detailSpec.H.Equals("0") ? String.Format("<{0}", detailSpec.H) : detailSpec.H);
                            break;
                    }

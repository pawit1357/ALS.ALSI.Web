                            ...
                            <div class="col-md-9">
                                ...
                                <asp:GridView ID="gvWftir" CssClass="table table-striped table-bordered mini" runat="server" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Silicone (Adhesive side)" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Literal ID="litF" runat="server" Text='<%# Eval("F")%>'></asp:Literal>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Silicone (Facing adhesive side)" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                    ...
                    <asp:Panel ID="PNvr" runat="server">
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                NVR-DI
                                <br />
                                <asp:GridView ID="gvNVrDI" CssClass="table table-striped table-bordered mini" runat="server" AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Literal ID="litA" runat="server" Text='<%# Eval("A")%>' />
                                ...
                                NVR-IPA,hexane
                                <br />
                                <asp:GridView ID="gvNvrIPA" CssClass="table table-striped table-bordered mini" runat="server" AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Literal ID="litA" runat="server" Text='<%# Eval("A")%>' />

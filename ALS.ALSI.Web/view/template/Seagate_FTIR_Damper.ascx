...
35344-001 Rev T"
                                                ...
                                                <tr runat="server" id="tab1_tr3">
                                                    <td class="auto-style1">FTIR
                                                        <br />
                                                        (Release Liner, ultra-low Silicone ,facing adhesive side)</td>
                                                    <td>
...
35344-001 Rev T"
 ...
 collapse;width:197pt" width="262">
                                                            <colgroup>
                                                                <col style="mso-width-source:userset;mso-width-alt:9581;width:197pt" width="262" />
                                                            </colgroup>
                                                            <tr height="76" style="height:57.0pt">
                                                                <td class="auto-style1" height="76" width="262">FTIR<br /> (Release Liner, ultra-low Silicone ,back, not facing adhesive side)</td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td>

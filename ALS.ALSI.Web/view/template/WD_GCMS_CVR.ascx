                                        ...
                                        <asp:GridView ID="gvCoverPages" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Results" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <EditItemTemplate>
                                                        <asp:DropDownList ID="ddlResult" runat="server" CssClass="span12 chosen" AutoPostBack="True"></asp:DropDownList>
                                                    </EditItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="PASS / FAIL" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <EditItemTemplate>
                                                        <asp:DropDownList ID="ddlPassFail" runat="server" CssClass="span12 chosen" AutoPostBack="True"></asp:DropDownList>
                                                    </EditItemTemplate>
                                                </asp:TemplateField>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <asp:Panel ID="pSpecification" runat="server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:DropDownList ID="ddlComponent" runat="server" CssClass="form-control select2-allow-clear" DataTextField="A" DataValueField="ID" OnSelectedIndexChanged="ddlComponent_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <%--                                            </div>--%>
                                    ...
                                    <asp:Panel ID="pDownload" runat="server">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <p class="text-success">ดาวโหลดไฟล์เพื่อทำการตรวจสอบหรือแก้ไข<asp:Label ID="lbExtension" runat="server" Text=""></asp:Label></p>
                                            </div>
                                        </div>

...
{
    public partial class TemplateLayout : System.Web.UI.UserControl
    {
        ...
        private void initialPage()
        {
            ...
            tb_ft_cfg_parameter tbFtCfgParameter = new tb_ft_cfg_parameter();
            List<tb_ft_cfg_parameter> paramValues = tbFtCfgParameter.selectByParamGroup(tb_ft_cfg_parameter.PARAM_GROUP_METHOD_PROCEDURE_HEADER);
            Console.WriteLine();
            foreach(tb_ft_cfg_parameter item in paramValues)
            {
                tb_ft_sample_mp tbFtSampleMp = new tb_ft_sample_mp
                {
                    sample_id = this.SampleID,
                    column_seq = item.param_seq.Value,
                    column_index = item.param_seq.Value,
                    column_value = "",
                    column_display_flag = "Y",
                    status = "Y",
            ...
            //    gv.ID = "_gridview";
            //    gv.CssClass = "table table-striped table-hover table-bordered";
            ...
            //pMethodOrProcedure.Controls.Add(gv);

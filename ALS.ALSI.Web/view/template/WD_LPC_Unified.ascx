<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WD_LPC_Unified.ascx.cs" Inherits="ALS.ALSI.Web.view.template.WD_LPC_Unified" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <asp:Panel ID="pTankConditions" runat="server">
                                <div class="row">
                                    <div class="col-md-6">
                                        <table class="table table-striped table-hover" id="Table1" runat="server" visible="false">
                                            <thead>
                                                <tr>
                                                    <th></th>

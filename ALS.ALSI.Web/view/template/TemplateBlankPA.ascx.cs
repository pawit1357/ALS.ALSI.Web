...
{
    public partial class TemplateBlankPA : System.Web.UI.UserControl
    {
        ...
        private void initialPage()
        {
            ...
            if (this.jobSample != null)
            {
                ...
                if(String.IsNullOrEmpty(this.jobSample.ad_hoc_tempalte_path) && String.IsNullOrEmpty(this.jobSample.path_pdf) && String.IsNullOrEmpty(this.jobSample.path_word)) {
                    pFileDownload.Visible = false;
                }
                else {
                    pFileDownload.Visible = true;
                ...
                switch (userRole)
                {
                    ...
                    case RoleEnum.ADMIN:
                        ...
                        switch (status)
                        {
                            case StatusEnum.ADMIN_CONVERT_WORD:
                                ...
                                lbDesc.Text = "ดาวโหลดไฟล์ ที่ผ่านการ Sr.Chemist Approve แล้วมาแปลงเป็นไฟล์ word";
                                break;
                            case StatusEnum.ADMIN_CONVERT_PDF:
                                ...
                                btnSubmit.Visible = true;
                                pCoverpage.Visible = false;
                                lbDesc.Text = "ดาวโหลดไฟล์ ที่ผ่านการ labManager Approve แล้วมาแปลงเป็นไฟล์ pdf";
                    ...
                    case RoleEnum.LABMANAGER:
                        ...
                        {
                            lbDownload.Text = this.jobSample.job_number;
                            lbDesc.Text = "ดาวโหลดไฟล์ word ที่ Admin แก้ไขแล้วมาตรวจสอบ";

        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            switch (status)
            {
                ...
                case StatusEnum.LOGIN_SELECT_SPEC:
                    ...
                    MaintenanceBiz.ExecuteReturnDt(string.Format("delete from template_seagate_corrosion_coverpage where sample_id={0}", this.SampleID));
                ...
                case StatusEnum.CHEMIST_TESTING:
                    ...
                    MaintenanceBiz.ExecuteReturnDt(string.Format("delete from template_seagate_corrosion_img where sample_id={0}", this.SampleID));

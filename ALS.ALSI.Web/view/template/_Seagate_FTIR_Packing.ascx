<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="_Seagate_FTIR_Packing.ascx.cs" Inherits="ALS.ALSI.Web.view.template._Seagate_FTIR_Packing" %>
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr runat="server" id="tab2_tr2">
                                                    <td>Silicone (Non-release side)</td>
                                                    <td>
                                                ...
                                                <tr runat="server" id="tab2_tr4">
                                                    <td>Hydrocarbon</td>
                                                    <td>
                                                        <asp:Label ID="lbB37" runat="server" Text=""></asp:Label></td>
                                                    <td>
                                                        <asp:Label ID="lbC37" runat="server" Text=""></asp:Label></td>
                                                    <td id="th1_cb4">
                                                ...
                                                <tr runat="server" id="tab2_tr5">
                                                    <td>Phthalate</td>
                                                    <td>
                                                        <asp:Label ID="lbB38" runat="server" Text=""></asp:Label></td>
                                                    <td>
                                                        <asp:Label ID="lbC38" runat="server" Text=""></asp:Label></td>
                                                    <td id="th1_cb5">
                                                        <asp:CheckBox ID="CheckBox12" runat="server" Checked="true" /></td>
                                                </tr>
                                                <tr runat="server" id="tab2_tr6">
                                                    <td>Amide</td>
                                                    <td>
                                                        <asp:Label ID="lbB39" runat="server" Text=""></asp:Label></td>
                                                    <td>
                                                        <asp:Label ID="lbC39" runat="server" Text=""></asp:Label></td>
                                                    <td id="th1_cb6">
                                                        <asp:CheckBox ID="CheckBox17" runat="server" Checked="true" /></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>

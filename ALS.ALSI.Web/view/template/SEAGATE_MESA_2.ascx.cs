...
{
    public partial class SEAGATE_MESA_2 : System.Web.UI.UserControl
    {
        ...
        private void initialPage()
        {
            ...
            if (status == StatusEnum.CHEMIST_TESTING || userLogin.role_id == Convert.ToInt32(RoleEnum.CHEMIST))
            {
                ...
                gvRefImages.Columns[3].Visible = true;
                gvRefImages.Columns[4].Visible = true;
        ...
        protected void lbDownload_Click(object sender, EventArgs e)
        {
            ...
            reportParameters.Add(new ReportParameter("Test", "Ghost Test on Drive Component"));
            ...
            foreach (template_seagate_mesa_img _i in dat)
            {
                ...
                {
                    _i.img4 = CustomUtils.GetBytesFromImage(_i.path_sem_image_at_500x);
                }
            }
            ...
            viewer.LocalReport.ReportPath = Server.MapPath("~/ReportObject/mesa_seagate_2.rdlc");

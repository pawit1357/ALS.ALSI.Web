<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WD_KPA.ascx.cs" Inherits="ALS.ALSI.Web.view.template.WD_KPA" %>
                                        ...
                                        <table class="table table-striped table-hover table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Procedure No</th>
                                                    <th>Component</th>
                                                    <th>Number of pieces <br />used for extraction</th>
                                                    <th>Extraction Volume <br />(mL)</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtA23" runat="server" Text="Inorganic Killer Particle Analysis" CssClass="form-control"></asp:TextBox>
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <asp:GridView ID="gvResult" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Result(Particles/part)" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Literal ID="litC" runat="server" Text='<%# Eval("C")%>'></asp:Literal>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Specification Limit(Particles/part)" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>

...
namespace ALS.ALSI.Web.view.template
{
    public partial class PA01 : System.Web.UI.UserControl
    {
                                    ...
                                    if (Path.GetFileNameWithoutExtension(_postedFile.FileName).StartsWith("reflectiveTable"))
                                    {
                                        if (line.IndexOf("<Cell>") != -1)
                                        {
                                            ...
                                            if (tmp.Length == 16)
                                            {
                                                ...
                                                template_pa_detail _tmp = paList.Where(x => x.col_d.Equals(tmp[0])).FirstOrDefault();
        ...
        protected void lbDownload_Click(object sender, EventArgs e)
        {
            ...
            this.pa.isultrasonic_text = cbInternalRinsing.Checked.ToString();
            ...
            this.pa.iswashultrasonic_text = cbWashInternalRinsing.Checked.ToString();

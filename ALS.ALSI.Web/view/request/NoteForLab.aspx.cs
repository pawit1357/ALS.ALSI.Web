...
{
    public partial class NoteForLab : System.Web.UI.Page
    {
        ...
        private void fillinScreen()
        {
            ...
            if (jobSample != null)
            {
                ...
                txtNoteForLab.Text = jobSample.note_lab;
            }
            else
            {
        ...
        {
            jobSample.note_lab = txtNoteForLab.Text;

<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ChangeJobPo.aspx.cs" Inherits="ALS.ALSI.Web.view.request.ChangeJobPo" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group" style="text-align: left">
                                        <asp:TextBox ID="txtInvoice" name="txtInvoice" runat="server" CssClass="form-control"></asp:TextBox>
                                        <span class="input-group-btn"></span>
                                    </div>
                                </div>
                            </div>

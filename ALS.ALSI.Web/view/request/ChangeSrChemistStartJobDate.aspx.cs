...
{
    public partial class ChangeSrChemistStartJobDate : System.Web.UI.Page
    {
        ...
        private void fillinScreen()
        {
            ...
            {
                txtDuedate.Text = Convert.ToDateTime(this.jobSample.date_srchemist_analyze).ToString("dd/MM/yyyy");
            }
            else
            {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            this.jobSample.date_srchemist_analyze = CustomUtils.converFromDDMMYYYY(txtDuedate.Text);

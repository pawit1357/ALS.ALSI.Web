<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ChangeJobSrCompleteDate.aspx.cs" Inherits="ALS.ALSI.Web.view.request.ChangeJobSrCompleteDate" %>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Change Sr Chemist Complete Date</span>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">Sr Chemist Complete Date:</label>
                                <div class="col-md-6">

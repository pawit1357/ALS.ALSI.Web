<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AdminPrint.aspx.cs" Inherits="ALS.ALSI.Web.view.request.AdminPrint" %>
                ...
                <div class="portlet box blue-dark">
                    ...
                    <div class="portlet-body">
                        ...
                        <asp:GridView ID="gvJob" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                            CssClass="table table-striped table-hover table-bordered" ShowHeaderWhenEmpty="True" DataKeyNames="sn" OnSelectedIndexChanged="gvJob_SelectedIndexChanged"  OnPageIndexChanging="gvJob_PageIndexChanging" PageSize="20">
                            <Columns>

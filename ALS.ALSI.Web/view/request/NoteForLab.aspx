<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="NoteForLab.aspx.cs" Inherits="ALS.ALSI.Web.view.request.NoteForLab" %>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Note for lab</span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group" style="text-align: left">
                                        <asp:TextBox ID="txtNoteForLab" name="txtNoteForLab" runat="server" class="form-control"></asp:TextBox>

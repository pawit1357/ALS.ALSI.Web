...
CREATE TABLE `job_info` (
  ...
  KEY `fk_completion_schedule_idx` (`status_completion_scheduled`),
...
INSERT INTO `job_info` VALUES (4,6,6,'2015-02-14','','',3,'00004','2015-02-14','','','Y','N','Y','Y','Y','Y',1,1,1,'2015-02-14','2015-02-14','1'),(5,5,5,'2015-02-15','','',2,'00002','2015-02-15','','','Y','N','Y','Y','Y','Y',2,1,1,'2015-02-15','2015-02-15','1'),(6,5,5,'2015-02-15','','',1,'00003','2015-02-15','','','Y','N','Y','Y','Y','Y',3,1,1,'2015-02-15','2015-02-15','1');
...
INSERT INTO `job_running` VALUES (1,'ELP',3),(2,'ELS',2),(3,'FA',4),(4,'ELWA',1),(5,'GRP',1),(6,'TRB',1);
...
INSERT INTO `job_sample` VALUES (9,4,1,5,34,'FA-00004-IB','RQ13-0662 Kojin APFA ww# 10 After Crest# 11 cell# 14 MinAik/ Engtek/ TI+SUMI/ Rencol/ NMB/ IPT(ECD)','Kojin APFA ','APFA = 143 cm2 AFA = 132 cm2','',1,'N',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,1,NULL),(10,4,1,6,-1,'FA-00004-LB','RQ13-0662 Kojin APFA ww# 10 After Crest# 11 cell# 14 MinAik/ Engtek/ TI+SUMI/ Rencol/ NMB/ IPT(ECD)','Kojin APFA ','APFA = 143 cm2 AFA = 132 cm2','',1,'N',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,20,1,NULL),(11,4,1,22,-1,'FA-00004-H','RQ13-0662 Kojin APFA ww# 10 After Crest# 11 cell# 14 MinAik/ Engtek/ TI+SUMI/ Rencol/ NMB/ IPT(ECD)','Kojin APFA ','APFA = 143 cm2 AFA = 132 cm2','',1,'N',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,21,1,NULL),(12,5,1,1,-1,'ELS-00002-F','RQ13-0662 Kojin APFA ww# 10 After Crest# 11 cell# 14 MinAik/ Engtek/ TI+SUMI/ Rencol/ NMB/ IPT(ECD)','Kojin APFA ','APFA = 143 cm2 AFA = 132 cm2','',1,'N',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,1,'2015-02-23'),(13,5,1,2,-1,'ELS-00002-F','RQ13-0662 Kojin APFA ww# 10 After Crest# 11 cell# 14 MinAik/ Engtek/ TI+SUMI/ Rencol/ NMB/ IPT(ECD)','Kojin APFA ','APFA = 143 cm2 AFA = 132 cm2','',1,'N',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,1,'2015-02-23'),(14,6,1,1,-1,'ELP-00003-F','RQ13-0662 Kojin APFA ww# 10 After Crest# 11 cell# 14 MinAik/ Engtek/ TI+SUMI/ Rencol/ NMB/ IPT(ECD)','Kojin APFA ','APFA = 143 cm2 AFA = 132 cm2','',1,'N',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,1,'2015-02-16'),(15,6,1,3,-1,'ELP-00003-F','RQ13-0662 Kojin APFA ww# 10 After Crest# 11 cell# 14 MinAik/ Engtek/ TI+SUMI/ Rencol/ NMB/ IPT(ECD)','Kojin APFA ','APFA = 143 cm2 AFA = 132 cm2','',1,'N',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,1,'2015-02-16');
...
INSERT INTO `m_status` VALUES (1,1,'JOB_CANCEL'),(2,1,'LOGIN_WAITING'),(3,1,'LOGIN_INPROCESS'),(4,1,'LOGIN_PROCESSED'),(5,1,'CHEMIST_WAITING'),(6,1,'CHEMIST_INPROCESS'),(7,1,'CHEMIST_PROCESSED'),(8,1,'SR_CHEMIST_WAITING'),(9,1,'SR_CHEMIST_INPROCESS'),(10,1,'SR_CHEMIST_APPROVE'),(11,1,'SR_CHEMIST_DISAPPROVE'),(12,1,'ADMIN_WAITING'),(13,1,'ADMIN_INPROCESS'),(14,1,'ADMIN_CONVERTED_WORD'),(15,1,'LABMANAGER_WAITING'),(16,1,'LABMANAGER_INPROCESS'),(17,1,'LABMANAGER_APPROVE'),(18,1,'LABMANAGER_DISAPPROVE'),(19,1,'ADMIN_CONVERTED_PDF'),(20,1,'JOB_COMPLETE'),(21,1,'JOB_HOLD');
...
CREATE TABLE `template_29_workingpg_ic` (
  ...
  PRIMARY KEY  (`ID`),
  KEY `fk_job_id_1_idx` (`job_id`),
  KEY `fk_specification_1_idx` (`specification_id`),
  CONSTRAINT `fk_job_id` FOREIGN KEY (`job_id`) REFERENCES `job_info` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tem_29_spec` FOREIGN KEY (`specification_id`) REFERENCES `template_29_specification` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-02-15 23:10:48
